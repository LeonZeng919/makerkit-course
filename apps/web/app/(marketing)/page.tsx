  ...
  return (
    <div className={'mt-4 flex flex-col space-y-24 py-14'}>
      <Hero
        pill={
          <Pill label={'New'}>
            <span>The customer support tool you were looking for</span>
          </Pill>
        }
        title={
          <>
        ...
        subtitle={
          <span>
            Collect and manage customer support in one place. Solve customer
            issues faster and keep them happy. Start for free. No credit card
            required.
          </span>
        }
